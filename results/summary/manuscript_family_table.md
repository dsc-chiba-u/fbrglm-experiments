...
|Negative binomial       |overdispersed count |                    0|        10.0|             8.0|fbrglm + glmnetUtils (parsnip not attempted) |fixed theta; MASS::negative.binomial() |
|Cox                     |Surv(time, status)  |                    0|         7.0|             3.0|fbrglm + glmnetUtils (parsnip not attempted) |native glmnet Cox; relative-risk scale |
|Multinomial             |multiclass factor   |                    0|        11.0|             7.0|fbrglm + glmnetUtils + parsnip               |(n x k) matrix output                  |
